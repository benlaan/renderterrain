...
{
    internal struct VertexMultiTextured
    {
        internal VertexMultiTextured(System.Drawing.Point p, Terrain terrain)
        {
        ...
        private void SetTexture(float height)
        {
            ...
            TexWeights.Z = GetBlendDistribution(height, 110, 155);
            TexWeights.W = GetBlendDistribution(height, 145, 200);
